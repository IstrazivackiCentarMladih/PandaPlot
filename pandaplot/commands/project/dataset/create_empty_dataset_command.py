...
class CreateEmptyDatasetCommand(Command):
    ...
    def execute(self, dataset_name: Optional[str] = None, **kwargs):
        ...
        try:
            ...
            print(f"CreateEmptyDatasetCommand: Created empty dataset '{self.dataset_name}' with ID '{self.dataset_id}'")
            ...
            self.ui_controller.show_error_message("Create Dataset Error", error_msg)
            return False
        ...
        try:
            if self.dataset_id and self.app_state.has_project:
                ...
                if project:
                    ...
                    print(f"CreateEmptyDatasetCommand: Undone creation of dataset '{self.dataset_id}'")
