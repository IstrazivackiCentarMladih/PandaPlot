...
class SimpleCommand(Command):
    """Simple test command recording operations."""
    ...
    def __init__(
        ...
        *,
        ...
        self.marks_project_modified = marks_modified
...
def test_composite_command_marks_project_modified():
...
def test_composite_command_noop_handling():
    cmd1 = SimpleCommand("c1", execute_result=CommandResult.NOOP, undo_result=CommandResult.NOOP, redo_result=CommandResult.NOOP)
    cmd2 = SimpleCommand("c2", execute_result=CommandResult.NOOP, undo_result=CommandResult.NOOP, redo_result=CommandResult.NOOP)
